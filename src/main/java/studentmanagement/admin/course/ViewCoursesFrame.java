...
public class ViewCoursesFrame extends JFrame {
    ...
    // =========================================================
    // COLORS - MATCHING DASHBOARD & ADD COURSE THEME
    // =========================================================
    ...
    private void createHeader() {
        ...
        JLabel subtitle = new JLabel("List of all registered courses in the system");
    ...
    private void styleTable(JTable table) {
        ...
        // Center align Course ID column
        DefaultTableCellRenderer centerRenderer = new DefaultTableCellRenderer();
        centerRenderer.setHorizontalAlignment(JLabel.CENTER);
        table.getColumnModel().getColumn(0).setCellRenderer(centerRenderer);

        // Padding and alignment for name and description
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            ViewCoursesFrame frame = new ViewCoursesFrame();
